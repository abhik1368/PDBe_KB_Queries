MATCH (entry:Entry{ID:'3d12'})-[:HAS_ENTITY]->(entity:Entity)-[:HAS_PDB_RESIDUE]->(pdb_res:PDBResidue)-[:HAS_PISA_BOND]-(interacting_pdb_res:PDBResidue)<-[:HAS_PDB_RESIDUE]-(partner_entity:Entity)-[:HAS_UNIPROT]->(uniprot:UniProt)
